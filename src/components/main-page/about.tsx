        ...
        <div className="flex flex-col md:flex-row gap-8 items-center">
          <div className="">
            ...
            <div className={`relative ${!isExpanded ? 'max-h-96 overflow-hidden' : ''}`}>
              <div className={`text-white/80 space-y-4 ${!isExpanded ? 'pb-12' : ''}`}>
                <p>
            ...
            <button
              ...
              className={`mt-4 w-full md:w-auto px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-md transition-colors ${isExpanded ? 'md:mx-auto' : ''}`}
            >
